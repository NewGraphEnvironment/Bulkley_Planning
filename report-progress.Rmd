...
kml_open(paste0("data/outgoing/",bname, "_barrier_assessments.kml"))
kml_layer(df, shape = df$shape, colour = df$color, labels = df$label, html.table = df$html_tbl, z.scale = 2, LabelScale = 1, size = 2)
kml_close(paste0("data/outgoing/",bname, "_barrier_assessments", format(Sys.time(),"_%Y%m%d_%H%M.kml")))
