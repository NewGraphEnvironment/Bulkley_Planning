...
kml_open("data/outgoing/habitat_data.kml")
kml_layer(df_kml, shape = shape, colour = 'yellow', labels = label, html.table = df_kml$html_tbl, z.scale = 2, LabelScale = 1, size = 2)
kml_close("data/outgoing/habitat_data.kml")

```

```{r zip-kml}
##now we will zip up the kml files in the data folder and rename with kmz
files_to_zip <- paste0("data/outgoing/", list.files(path = "data/gis/outgoing/", pattern = "\\.kml$"))  ##this used to includes the planning file which we don't want to do so watch out
