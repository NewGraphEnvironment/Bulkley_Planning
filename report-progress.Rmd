...
# df <- import_pscis(workbook_name = workbook_name) %>% 
#   make_kml_col()  %>% 
#   dplyr::group_split(site_id) %>%
#   purrr::map(make_html_tbl) %>%
#   dplyr::bind_rows() %>% 
#   dplyr::mutate(source = tools::file_path_sans_ext(workbook_name))
# 
...
kml_close("data/outgoing/barrier_assessments.kml")
